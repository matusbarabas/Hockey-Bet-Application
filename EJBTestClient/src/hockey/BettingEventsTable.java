...
/**
 * Trieda na pripravu dat do tabulky stavkovych prilezitosti.
 * @author Matus Barabas
 *
 */
public class BettingEventsTable {
	private Integer id;
	...
	public BettingEventsTable(Integer id, String home_team, String guest_team, Double h_line, Double d_line, Double v_line) {
		super();
		this.id = id;
