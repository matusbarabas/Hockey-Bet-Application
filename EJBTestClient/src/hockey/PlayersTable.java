...
/**
 * Trieda na pripravu dat do tabulky o vsetkych hracoch.
...
public class PlayersTable {
	...
	public PlayersTable(String p_name, String p_team, Date date_f, Date date_t, String p_pos, Integer p_goals,
